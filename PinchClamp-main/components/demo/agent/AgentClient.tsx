                    ...
                    if (line.startsWith("event: ")) {
                        ...
                        try {
                            ...
                            if (currentEvent === "status") {
                                ...
                                if (data.message && data.message.includes("Rate limit reached")) {
                                    setStatus("idle");
                        ...
                        {!(showLogs || showReport) ? (
                            <div>
                                ...
                                <p className="text-xs text-pinch-muted -mt-0.5 hidden sm:block">
                                    GPT-OSS 120B manager · Qwen 3.6 27B worker · via Groq
                                </p>
                            </div>
                        ) : (
                            <div>
                                    ...
                                    {contactSubmitted ? (
                                        ...
                                        <>
                                            <div className="mb-5">
                                                ...
                                                <p className="text-sm text-pinch-muted">
                                                    We're working on it! Want to see Agents in action aligned to your goals?
                                                </p>
                                            </div>
